...
export const actionHandlers = {
    ...
    'print-student-sheet': () => {
        ...
        Object.values(annotationsByClass).forEach(classData => {
            classData.annotations.sort((a, b) => b.date - a.date);
        });
            ...
            <html>
                <head>
                    ...
                    <style>
                        ...
                        h2 { font-size: 16pt; border-bottom: 1px solid #ccc; padding-bottom: 5px; margin-top: 25px; margin-bottom: 15px; page-break-after: avoid; }
                        h3 { font-size: 14pt; font-weight: bold; margin-top: 20px; margin-bottom: 10px; page-break-after: avoid; }
                        ...
                        <div>
                            ...
                            ${classData.annotations.map(item => `
                                <div class="annotation-item">
                                    <p class="annotation-date">${item.date.toLocaleDateString(document.documentElement.lang, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
        ...
        printWindow.onload = function() { // Espera a que el contenido esté cargado
            printWindow.focus();
            printWindow.print();
            printWindow.close();
        };
